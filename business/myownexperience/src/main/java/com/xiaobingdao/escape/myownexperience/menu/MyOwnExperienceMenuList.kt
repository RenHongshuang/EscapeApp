package com.xiaobingdao.escape.myownexperience.menu
...
import com.xiaobingdao.escape.myownexperience.activity.EscapeAppCorourtineDemoActivity
import com.xiaobingdao.escape.myownexperience.activity.EscapeAppNetworkDemoActivity
import com.xiaobingdao.escape.myownexperience.activity.EscapeAppStateMachineDemoActivity
        ...
        when (caller) {
            Caller.MY_OWN_EXPERIENCE -> {
                when (menu) {
                    ...
                    COROUTINE -> {
                        intent = Intent(context, EscapeAppNetworkDemoActivity::class.java)
                    }
                }
            }
        }
