package com.xiaobingdao.escape.architecturecomponent.ui.frame
...
import com.xiaobingdao.escape.architecturecomponent.ui.menu.ArchitectureComponentMenuList
...
class ArchitectureComponentFrame(frameDomain: String) : EscapeAppFrameInterface(frameDomain, ArchitectureComponentFrame::class) {
    override fun onBindFrameView(context: Context?, frameData: FrameData): EscapeAppFrameLayoutBinder {
        ...
        context?.let {
            ...
            escapeAppFrameLayoutBinder.titleTextResId = R.string.architecture_component
            ...
            childView?.let {
                ...
                recyclerView.adapter = HomeCommonFrameAdapter(context, ArchitectureComponentMenuList(), EscapeAppMenuListInterface.Caller.ARCHITECTURE_COMPONENT)
            }
        }
