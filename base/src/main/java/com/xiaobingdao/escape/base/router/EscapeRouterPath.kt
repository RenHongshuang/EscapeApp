...
object EscapeRouterPath {
    ...
    const val EscapeAppNetworkDemoActivity ="/myownexperience/EscapeAppNetworkDemoActivity"
    const val EscapeAppCorourtineDemoActivity ="/myownexperience/EscapeAppCorourtineDemoActivity"
    const val EscapeAppStateMachineDemoActivity ="/myownexperience/EscapeAppStateMachineDemoActivity"

    const val UiComponentModuleService ="/uicomponent/UiComponentModuleService"
    const val UiComponentActivity ="/uicomponent/UiComponentActivity"
